  ...
  <body style="background-color: #e1e1e1;">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navigasi" style="background-color: #F19066; height: 80px;">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin-left: 37%;">
    ...
    <div class="container " id="beranda" style="background-color: white; margin-top: 6.5%; max-width: 100%; height: 740px; max-height: 1080px;">
        <div class="row">
            <div class="col-md-4" style="margin-top: 15%; margin-left: 8%;">
                <div class="container">
                    <img src="assets/img/pangsit.jpg" alt="" style="max-width: 550px;  border-radius: 5%; box-shadow: 2px 2px 5px #333333;">
                </div>
            </div>

            <div class="col-md-5" style="margin-top: 17%; margin-left: 13%;">
                ...
                <div class="container" style="color: #F19066; text-align: right;">
                    <h3>Beli Sekarang <i class="fa-solid fa-arrow-right-long"></i></h3>
                </div>
                </div>
            </div>
        </div>
